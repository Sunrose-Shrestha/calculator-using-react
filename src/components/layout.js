    ...
    return (
        <div className="frame">
            <div className="calculator">
                ...
                <img src={logo} width="150px" style={{display:'block', marginLeft:'auto', marginRight:'auto', marginTop:'20px', marginBottom:'10px'}}/>
                <div className="keys">
                    <input type='button' value={'C'} className='button clear' onClick={handleClick}></input>
                    <input type='button' value={'CE'} className='button clear' onClick={handleClick}></input>
